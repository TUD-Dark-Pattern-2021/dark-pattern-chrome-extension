...
function openSideWindow() {
    ...
    sideWindow.innerHTML = `<div class="sidewindow" id="hello">

    <div id="closeSW" class="close_all">
        <i class="fa fa-chevron-down fa-lg minimizeIcon" id="closeSW"></i>
        <i class="fas fa-arrow-down"></i>

        <div class="close_text">Switch to Tool Bar</div>
    </div>
    ...
    <button id = "Scan">Scan for DP</button>
</div>`



    // sideWindow.innerHTML = `
    // <div class="contentContainer" id="contentsize">
    ...
    //         </div>
    //     </div>
    //     <div class="rep-amort-page showpage" style="display: none;">
